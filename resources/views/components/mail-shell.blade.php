...
<body style="margin:0; padding:0; background:#f3f6f3; color:#17201c; font-family:Arial, Helvetica, sans-serif;">
        ...
        <tr>
            <td align="center" style="padding:30px 12px;">
                <table role="presentation" width="620" cellspacing="0" cellpadding="0" border="0" class="email-shell" style="width:620px; max-width:620px;">
                    <tr>
                        <td class="email-padding" style="padding:27px 30px; background:#17201c; border-radius:18px; color:#ffffff;">
                            <div style="color:#c8ff48; font-size:13px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase;">Incline Fitness</div>
                            <h1 style="margin:12px 0 7px; font-size:28px; line-height:1.15; color:#ffffff;">{{ $title }}</h1>
                            <div style="color:#d8e1dc; font-size:15px; line-height:1.5;">{{ $preheader }}</div>
                        </td>
                    </tr>
                    <tr><td style="height:16px;"></td></tr>
                    {{ $slot }}
                    <tr>
                        <td style="padding:22px 18px 6px; color:#66736c; font-size:11px; line-height:1.6; text-align:center;">
