    ...
    @if ($submittedReference)
        <section data-state="success" role="status" aria-live="polite" class="incline-card overflow-hidden text-center shadow-incline">
            ...
            <div class="p-8 sm:p-14">
                ...
                <h1 class="incline-heading mt-2 text-4xl uppercase">Enrollment complete</h1>
                <p class="mx-auto mt-4 max-w-lg leading-relaxed text-muted">Thank you. Your membership enrollment was submitted successfully. Please check your email for your confirmation.</p>
