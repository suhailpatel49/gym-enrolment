<x-mail-shell title="New membership enrollment" preheader="A new enrollment has been submitted.">
    ...
    <tr>
        <td class="email-padding" style="padding:23px 26px; background:#ffffff; border:1px solid #dde4df; border-radius:16px;">
            <h2 style="margin:0 0 17px; color:#17201c; font-size:17px;">Member details</h2>
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td class="stack-cell" width="50%" style="padding:0 12px 17px 0; vertical-align:top;">
                        <div style="color:#66736c; font-size:10px; letter-spacing:.6px; text-transform:uppercase;">Member</div>
                        <div style="margin-top:4px; color:#17201c; font-size:14px; font-weight:700;">{{ $enrollment->full_name }}</div>
                    </td>
                    <td class="stack-cell" width="50%" style="padding:0 0 17px 12px; vertical-align:top;">
                        <div style="color:#66736c; font-size:10px; letter-spacing:.6px; text-transform:uppercase;">Mobile</div>
                        <div style="margin-top:4px; color:#17201c; font-size:14px; font-weight:700;">{{ $enrollment->mobile_number }}</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="padding:0; vertical-align:top;">
                        <div style="color:#66736c; font-size:10px; letter-spacing:.6px; text-transform:uppercase;">Email</div>
                        <div style="margin-top:4px; color:#17201c; font-size:14px; font-weight:700;">{{ $enrollment->email }}</div>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td class="email-padding" style="padding:23px 26px; background:#ffffff; border:1px solid #dde4df; border-radius:16px;">
            <h2 style="margin:0 0 17px; color:#17201c; font-size:17px;">Membership and payment</h2>
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td class="stack-cell" width="50%" style="padding:0 12px 17px 0; vertical-align:top;">
                    ...
                    <td class="stack-cell" width="50%" style="padding:0 0 17px 12px; vertical-align:top;">
                        <div style="color:#66736c; font-size:10px; letter-spacing:.6px; text-transform:uppercase;">Membership dates</div>
                        <div style="margin-top:4px; color:#17201c; font-size:14px; font-weight:700;">{{ $enrollment->membership_start_date->format('d M Y') }} to {{ $enrollment->membership_end_date->format('d M Y') }}</div>
                    </td>
                </tr>
                <tr>
                    <td class="stack-cell" width="50%" style="padding:0 12px 0 0; vertical-align:top;">
                        <div style="color:#66736c; font-size:10px; letter-spacing:.6px; text-transform:uppercase;">Payment</div>
                        <div style="margin-top:4px; color:#17201c; font-size:14px; font-weight:700;">{{ strtoupper($enrollment->payment_mode) }} - INR {{ number_format((float) $enrollment->amount_paid, 2) }}</div>
                    </td>
